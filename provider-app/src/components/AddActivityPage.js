...
export default function AddActivityPage() {
  ...
  return (
    <div class='mx-auto mt-10 w-8/12 max-w-4xl text-gray-700 overflow-hidden font-light'>
      ...
      <div class='flex mt-6 mx-auto justify-between'>
        <div class='w-full'>
      ...
      <div class='flex mt-6 justify-between'>
        ...
        <button class='bg-cyan hover:bg-hover w-1/3 h-12 rounded-full shadow'>Νέα Υποδομή</button>
      </div>
      <div class='mt-10'>
      ...
      <button class='bg-cyan w-full my-10 rounded-full h-14 hover:bg-hover shadow'>Καταχώρηση Δραστηριότητας</button>
    </div>
  );
}
