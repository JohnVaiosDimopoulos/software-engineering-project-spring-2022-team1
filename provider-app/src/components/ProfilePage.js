  ...
  return (
    <div class='mx-auto mt-10 px-10 w-9/12 text-gray-700 overflow-hidden font-light'>
      ...
      <div class='flex justify-between mt-8'>
        <input type='text' class='w-1/2 p-1 rounded-full shadow' id='name' placeholder='Όνομα Χρήστη'/><br/>
        <button class='bg-cyan w-1/3 h-8 mx-auto text-lg rounded-full shadow'>Επεξεργασία</button>
      </div>
      <div class='flex justify-between mt-8'>
        <input type='text' class='w-1/2 p-1 rounded-full shadow' id='email' placeholder='Διεύθυνση Email'/><br/>
        <button class='bg-cyan w-1/3 h-8 mx-auto text-lg rounded-full shadow'>Επεξεργασία</button>
      </div>
      <div class='flex justify-between mt-8'>
        <input type='password' class='w-1/2 p-1 rounded-full shadow' id='password' placeholder='Κωδικός'/>
        <button class='bg-cyan w-1/3 h-8 mx-auto text-lg rounded-full shadow'>Επεξεργασία</button>
      </div>
      ...
      <div class='flex justify-between mt-8'>
        <input type='watermark' class='w-1/2 p-1 rounded-full shadow' id='text' placeholder='Μέχρι 30 χαρακτήρες'/>
        <button class='bg-cyan w-1/3 h-8 mx-auto text-lg rounded-full shadow'>Προσθήκη</button>
      </div>
      ...
      <input type='points' class='w-1/2 p-1 rounded-full shadow' id='text' placeholder='Αριθμός $'/>
